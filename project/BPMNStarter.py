...
def start_task(input_path, title, output_path, debug=False):
    ...
    document = nlp(text_input) #TODO: Text Input could be a paramter of remove_introduction_sentence, so we do not need
    ...
    valid_actors = get_valid_actors_vh(containerList, nlp_similarity)
